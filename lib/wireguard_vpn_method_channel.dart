...
class MethodChannelWireguardVpn extends WireguardVpnPlatform {
  ...
  Future<
      ...
      /// `Stats` is a class that represents the statistics of a Wireguard VPN tunnel. It is used in
      /// the `tunnelGetStats` method of the `MethodChannelWireguardVpn` class to deserialize the
      /// JSON response from the native platform into a Dart object.
      Stats?> tunnelGetStats(String name) async {
    try {
